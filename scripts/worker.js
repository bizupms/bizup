...
function buildTelegramMessage(fields, submitDate, submitTime) {
  ...
  msg +=
    '\n\n📋 <a href="https://admin.bizupms.com/leads">접수관리 바로가기</a>';
  return msg;
}
...
async function sendDailyTelegramReport(env, data) {
  ...
  msg += `\n📋 <a href="https://admin.bizupms.com/">관리자 대시보드</a>`;
