...
const SRC = 'F:/pola_homepage/31.26_2th_seongjuseok_bizup/images/board/sora_raw';
const DEST = 'F:/pola_homepage/31.26_2th_seongjuseok_bizup/images/board/sora_webp';
...
async function main() {
  ...
  console.log('\n=== Step 2: Upload to R2 ===');
  const wranglerDir = 'F:/pola_homepage/31.26_2th_seongjuseok_bizup/scripts';
